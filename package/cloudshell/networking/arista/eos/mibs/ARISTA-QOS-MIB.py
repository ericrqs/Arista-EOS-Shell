...
aristaQosMib = ModuleIdentity((1, 3, 6, 1, 4, 1, 30065, 3, 13)).setRevisions(("2016-03-21 00:00","2014-08-15 00:00","2014-05-22 00:00","2013-06-01 00:00",))
...
aristaClassMapMatchType = MibTableColumn((1, 3, 6, 1, 4, 1, 30065, 3, 13, 1, 2, 1, 2), Integer().subtype(subtypeSpec=SingleValueConstraint(1,2,3,)).subtype(namedValues=NamedValues(("ipv4AccessGroup", 1), ("ipv6AccessGroup", 2), ("vlan", 3), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: aristaClassMapMatchType.setDescription("Indicates the type of a match criterion for a class map. \nipv4AccessGroup(1) means that it is an IPv4 access-control list. \nipv6AccessGroup(2) means that it is an IPv6 access-control list. \nvlan(3) means that the criterion is a masked VLAN value.")
...
aristaPolicyMapClassIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 30065, 3, 13, 1, 4, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 2147483647))).setMaxAccess("noaccess")
