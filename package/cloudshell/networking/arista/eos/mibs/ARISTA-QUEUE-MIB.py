...
aristaQueueMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 30065, 3, 6)).setRevisions(("2014-08-15 00:00","2012-08-23 13:00",))
...
if mibBuilder.loadTexts: aristaEgressQueueTable.setDescription("This table contains statistical objects for the egress queues\nof an interface.")
