...
"""
Tests for `AristaEOSShellDriver`
"""
import unittest
from mock import patch

from cloudshell.shell.core.context import ResourceCommandContext, ResourceContextDetails, ReservationContextDetails
from src.arista_eos_resource_driver import AristaEOSResourceDriver


@patch('src.arista_eos_resource_driver.get_api')
@patch('src.arista_eos_resource_driver.get_logger_with_thread_id')
@patch('src.arista_eos_resource_driver.ResourceCommandContext', autospec=ResourceCommandContext)
class TestAristaEOSShellDriver(unittest.TestCase):
    def setUp(self):
        self.driver = AristaEOSResourceDriver()

    @patch('src.arista_eos_resource_driver.get_attribute_by_name', return_value='1')
    @patch('src.arista_eos_resource_driver.get_cli')
    ...
    @patch('src.arista_eos_resource_driver.AutoloadRunner')
    ...
    @patch('src.arista_eos_resource_driver.CommandRunner')
    ...
    @patch('src.arista_eos_resource_driver.StateRunner')
    ...
    @patch('src.arista_eos_resource_driver.FirmwareRunner')
    ...
    @patch('src.arista_eos_resource_driver.FirmwareRunner')
    @patch('src.arista_eos_resource_driver.get_attribute_by_name')
    ...
    @patch('src.arista_eos_resource_driver.ConfigurationRunner')
    @patch('src.arista_eos_resource_driver.get_attribute_by_name')
    ...
    @patch('src.arista_eos_resource_driver.ConnectivityRunner')
