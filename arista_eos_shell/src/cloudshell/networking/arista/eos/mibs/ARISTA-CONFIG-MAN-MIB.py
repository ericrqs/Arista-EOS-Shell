...
class ConfigHistoryEventMedium(Integer):
    subtypeSpec = Integer.subtypeSpec+SingleValueConstraint(2,0,1,6,5,4,3,)
    namedValues = NamedValues(("none", 0), ("erase", 1), ("commandSource", 2), ("running", 3), ("startup", 4), ("url", 5), ("session", 6), )
    

# Objects

aristaConfigManMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 30065, 3, 9)).setRevisions(("2014-08-15 00:00","2014-05-06 13:00","2012-08-23 13:00",))
